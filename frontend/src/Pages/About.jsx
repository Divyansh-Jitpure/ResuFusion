    ...
    <>
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="w-1/2 text-xl text-gray-300">
          ...
          create stunning, professional resumes effortlessly. Whether you're a
          job seeker, a student, or a professional, ResuFusion gives you the
          tools to craft a perfect resume in minutes.
        </p>
